<div class="container-fluid mt-3">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <span class="navbar-brand">Anime Complete</span>
        <div class="ml-auto">
            <a href="{{ route('selengkapnya.index','Selesai Tayang') }}">
    ...
    <main class="border border-dark px-2">
        <div class="row mt-2 px-4">
            @foreach($anime_complete as $anime)
                <div class="anime_container mb-2 col-6 col-md-6 col-lg-12">
                    <a href = "{{route('detail_complete.index',[$anime->id,360,1])}}" style="text-decoration:none;">
